...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=0.0.2
```
...
module "static-website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=0.0.2"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 0.1.1 |
| <a name="module_s3"></a> [s3](#module\_s3) | github.com/pbs/terraform-aws-s3-module | 0.0.1 |
...
| <a name="input_acl"></a> [acl](#input\_acl) | Canned ACL for the bucket | `string` | `"private"` | no |
...
| <a name="input_cnames"></a> [cnames](#input\_cnames) | (optional) CNAME(s) that are going to be created for this cdn in the primary\_hosted\_zone. This can be set to [] to avoid creating a CNAME for the app. This can be useful for CDNs. Default is `product`. e.g. [service] --> [service.example.com] | `list(string)` | `null` | no |
