...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=3.0.3
```
...
module "static-website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=3.0.3"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 3.0.1 |
