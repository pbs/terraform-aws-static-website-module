...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=5.0.6
```
...
module "static-website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=5.0.6"
...
| <a name="module_s3"></a> [s3](#module\_s3) | github.com/pbs/terraform-aws-s3-module | 3.0.4 |
