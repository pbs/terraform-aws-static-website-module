...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=6.0.11
```
...
module "static_website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=6.0.11"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 3.1.14 |
