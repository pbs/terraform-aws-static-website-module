...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=4.0.7
```
...
module "static-website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=4.0.7"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 3.0.5 |
| <a name="module_s3"></a> [s3](#module\_s3) | github.com/pbs/terraform-aws-s3-module | 2.0.3 |
