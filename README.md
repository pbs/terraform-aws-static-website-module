...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=5.0.4
```
...
module "static-website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=5.0.4"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 3.1.6 |
| <a name="module_s3"></a> [s3](#module\_s3) | github.com/pbs/terraform-aws-s3-module | 3.0.2 |
