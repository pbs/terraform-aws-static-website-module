...
```hcl
github.com/pbs/terraform-aws-static-website-module?ref=6.0.13
```
...
module "static_website" {
  source = "github.com/pbs/terraform-aws-static-website-module?ref=6.0.13"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloudfront"></a> [cloudfront](#module\_cloudfront) | github.com/pbs/terraform-aws-cloudfront-module | 3.1.16 |
